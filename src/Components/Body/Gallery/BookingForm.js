...
const BookingForm = props => {
    ...
    return (
        <div className="p-3 myBGT">
            <h3 className="display-5 fw-bold text-center text-warning text-shadow">Your Information</h3>
                ...
                {({
                    ...
                    <div className="d-flex justify-content-center">
                        <form onSubmit={handleSubmit} className="col-12">
                            ...
                            <div className="d-flex justify-content-center">
                                <button className="btn btn-success rounded-pill px-5 py-2 fw-bold fs-6" type="submit" disabled={isSubmitting}>
                                    Rent
                                </button>
                            </div>
                        </form></div>
