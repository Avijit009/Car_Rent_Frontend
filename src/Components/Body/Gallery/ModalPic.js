    ...
    return (
        <Modal show={props.modalToggle} onHide={props.modalHandler}>
            ...
            <Modal.Body>
                ...
                {isRented ? (
                    <h3 className="text-center text-danger mt-4 mb-2">This Car is Already Rented</h3>
                ) : !userCanRent ? (
                    <p className="text-center fs-5 text-danger my-2">You Already have one Car Rented</p>
                ) : (
                    <>
