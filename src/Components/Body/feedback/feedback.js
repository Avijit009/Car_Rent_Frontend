...
const FeedBack = props => {
    ...
    return (
        <div>
            ...
            <h1 className="display-4 text-center text-info my-3 fw-bold">Add Your Car</h1>
            {/* <h4 className="text-center text-success my-3">Your Email: {userEmail}</h4> */}
            <Formik
                initialValues={{ car_name: "", car_detail: "", car_owner: "", car_category: "4", car_rent_price: "" }}
                validate={values => {
                    const errors = {};
                    // car_name
                    if (!values.car_name.length) errors.car_name = "Name can't empty";
                    // car_rent_price
                    if (!values.car_rent_price) errors.car_rent_price = "Rent should not be 0";
                    return errors;
                }}
                onSubmit={values => {
                    const carObj = {
